                ...
                child: _Columna(
                  ...
                  child: hayPlanta
                      ? Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            LevelMap(regiones: regiones, numeroDepa: numeroDepa),
                            const SizedBox(height: 6),
                            Text(
                              'Planta del nivel · tu unidad resaltada',
                              style: TextStyle(
                                  fontSize: 9.5, color: tone.textMuted),
                            ),
                          ],
                        )
                      : _RejillaUnidades(
...
class _ListaNivelesState extends State<_ListaNiveles>
  ...
  late final Animation<double> _anim =
      CurvedAnimation(parent: _elev, curve: Curves.easeInOut);
  bool _llego = false;
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            width: 1.5,
            height: 5,
            color: tone.textSecondary.withValues(alpha: 0.7),
          ),
          // Cabina.
          Container(
            width: 13,
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                ...
                colors: [tone.primary, tone.primaryDark],
              ),
              borderRadius: BorderRadius.circular(3),
              boxShadow: [
                BoxShadow(
...
class _FilaNivelState extends State<_FilaNivel>
  ...
  Widget build(BuildContext context) {
    ...
    final Color fondo = widget.oscuro ? tone.textPrimary : tone.surfaceAlt;
    ...
    final Gradient? gradient = verde
        ...
        : widget.oscuro
            ? LinearGradient(
                ...
                colors: [tone.textPrimary, tone.primaryDark],
              )
            : null;
    ...
    final Color borde = verde
        ? tone.primary
        : (widget.esCliente ? tone.primary.withValues(alpha: 0.45) : tone.border);
    ...
    final Color? ventanas = verde
        ...
        : widget.oscuro
            ...
            : tone.textSecondary.withValues(alpha: 0.10);
...
class _RejillaUnidadesState extends State<_RejillaUnidades>
  ...
  Widget _celda(int i) {
    ...
    final etiqueta = resaltado ? widget.unidad : '${widget.numeroPiso * 100 + i}';
            ...
            decoration: BoxDecoration(
              gradient: resaltado
                  ? LinearGradient(
                      ...
                      colors: [
                        Color.lerp(tone.primaryDark, tone.primary, t) ??
                            tone.primary,
                        tone.primary,
                      ],
                    )
...
class _RoofPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // Losa de azotea.
    final slab = Paint()..color = tone.textPrimary;
    canvas.drawRRect(
    ...
    final cap = Paint()..color = tone.textSecondary;
    canvas.drawRRect(
      RRect.fromLTRBR(
          m, h * 0.35 - 3, w - m, h * 0.35 + 1, const Radius.circular(1)),
      cap,
    );

    // Cuarto de máquinas / estructura de azotea.
    final mr = Paint()..color = tone.primaryDark;
...
class _BasePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    final w = size.width;
    final h = size.height;
    final ground = Paint()..color = tone.textPrimary;
    canvas.drawRRect(
      RRect.fromLTRBAndCorners(
        0,
        0,
    ...
    final line = Paint()..color = tone.textSecondary;
