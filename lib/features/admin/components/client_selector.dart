...
/// Filtros + buscador + resultados del selector de cliente, con el estado que
/// eso necesita: dos controladores de texto y sus temporizadores de debounce.
///
/// Vive fuera de la pantalla porque una pantalla ensambla y no guarda estado.
/// Es el mismo reparto que `login_screen` con `login_form`.
