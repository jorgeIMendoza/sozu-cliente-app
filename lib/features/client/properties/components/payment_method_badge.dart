...
/// Chip compacto con la forma de pago final elegida: recursos propios (STP) o
/// crédito hipotecario con el estatus de la solicitud. No renderiza nada
/// mientras `tipoFinanciamiento` sea null.
class PaymentMethodBadge extends StatelessWidget {
  ...
  Widget _credito(SozuColorRoles tone) {
    ...
    final titulo = (banco != null && banco != '-')
        ...
        : 'Crédito hipotecario';
    // Línea de seguimiento por estatus; sin solicitud aún → mensaje genérico.
  ...
  /// Línea de seguimiento por estatus de la solicitud.
  ...
  /// (etiqueta, tono) por estatus: aprobados en verde, rechazo/expiración en
  /// rojo, resto ámbar.
