...
import 'package:sozu_cliente_app/features/client/properties/components/level_map.dart';

/// Diagrama "¿Dónde está tu unidad?": columna de niveles con elevador animado
/// a la izquierda y la planta del nivel ([LevelMap]) a la derecha.
...
/// Losa / nivel del corte. El nivel del cliente arranca neutro y solo al llegar
/// el elevador (`activo == true`) pasa a verde, "respira" y muestra la flecha
/// "Tú".
