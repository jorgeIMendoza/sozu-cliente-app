...
/// [PortalAcquisitionCard] y [PortalPatrimonyCard]. No sustituyen a
/// `PropertyCardWidget` ni a `PatrimonioCard` (móvil): solo aplican cuando
...
/// "Ver detalle" verde con chevron, subrayado en hover.
...
// ---------------------------------------------------------------------------
// PortalPropertyCard - Inicio · Mis propiedades
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// PortalAcquisitionCard - Adquisición
// ---------------------------------------------------------------------------

/// Sombra de hover de las cards de adquisición, más marcada que
/// [_hoverShadow].
...
/// Punto de color del badge de estatus sobre la imagen:
...
// ---------------------------------------------------------------------------
// PortalPatrimonyCard - Mi patrimonio
// ---------------------------------------------------------------------------
...
class PortalPatrimonyCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Degrada al saldo pendiente si el backend aún no manda la cuota.
    ...
    return SPressable.detector(
      builder: (context, hovered, pressed) => GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          curve: context.s.motion.emphasized,
          transformAlignment: Alignment.center,
          // En hover la card se levanta 2px.
          transform: hovered
              ? Matrix4.translationValues(0, -2, 0)
              : Matrix4.identity(),
          clipBehavior: Clip.antiAlias,
