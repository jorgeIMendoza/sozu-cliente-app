...
/// del cliente con un pulso animado. Respeta el aspecto real del bounding box
/// de las regiones, no un cuadrado. Un icono de expandir lo abre en diálogo.
                ...
                Row(
                  children: [
                    ...
                    IconButton(
                      ...
                      icon: Icon(Icons.close, color: tone.fgMuted),
...
class _LevelPainter extends CustomPainter {
  ...
  /// Un `CustomPainter` no tiene `BuildContext`, asi que los roles de color
  /// entran por constructor como cualquier otro dato.
    ...
    for (final r in regiones) {
      ...
      canvas.drawPath(
        ...
        Paint()
          ..style = PaintingStyle.stroke
          ..strokeWidth = 6 + 16 * t
          ..color = tone.primary.withValues(alpha: 0.15 + 0.35 * t)
      ...
      canvas.drawPath(
        ...
        Paint()
          ..style = PaintingStyle.stroke
          ..strokeWidth = 3 + 6 * t
          ..color = tone.primary.withValues(alpha: 0.35 + 0.45 * t)
      ...
      canvas.drawPath(
        ...
        Paint()
          ..style = PaintingStyle.fill
          ..color = Color.lerp(tone.primaryHover, tone.primary, t)!,
      );
      canvas.drawPath(
        path,
        Paint()
      ...
      final tp = TextPainter(
        text: TextSpan(
          ...
          style: TextStyle(
            ...
            color: active ? tone.onPrimary : tone.fgMuted,
          ),
        ),
  ...
  bool shouldRepaint(covariant _LevelPainter old) =>
      old.regiones != regiones || old.target != target || old.bounds != bounds;
}
