...
/// Abre el flujo "Pago final" como drawer lateral derecho, la variante de
/// escritorio de `PagoFinalScreen`. Solo para modo portal (web ancho); en
/// móvil se conserva la pantalla completa.
