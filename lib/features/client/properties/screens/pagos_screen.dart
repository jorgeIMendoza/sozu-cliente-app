...
/// Pagos POR PROPIEDAD: primero se elige la propiedad, luego saldo global,
/// próximos pagos e historial con filtros (año/estatus/tipo), agrupación por
/// mes, cuotas de mantenimiento y recibo/CEP bajo demanda.
...
class _PagosScreenState extends ConsumerState<PagosScreen> {
  ...
  Widget _detalle(SozuColorRoles tone, ClientePagos data, String propiedad) {
    ...
    // Método de pago final elegido: lee el detalle ya cacheado con valueOrNull,
    // sin loading propio; si aún no hay datos no se muestra.
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  // MODO PORTAL (web ≥1024): "Historial de pagos".
  ...
  /// Fondo del encabezado de la tabla (muted aplanado).
  ...
  /// Sub-fila de pago aplicado: regla verde + método/monto
  ...
  // ── Card "Pagos registrados" con tabla ────────────────────────────────────
  Widget _portalTabla(
