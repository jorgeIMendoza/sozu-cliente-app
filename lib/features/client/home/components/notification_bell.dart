...
/// Campana de notificaciones con contador de no leídas. Al subir el conteo corre
/// la [AnimacionCampana] que eligió el admin y el badge se queda atrasado hasta
/// que aterriza; las bajadas (marcar leídas) se reflejan sin animación.
...
class _NotificationBellState extends ConsumerState<NotificationBell>
  ...
  void initState() {
    ...
    _vuelo.addStatusListener((status) {
      ...
      // Mismo token que el AnimatedScale de abajo: con dos valores sueltos el
      // regreso arranca antes de terminar de crecer y el brinco se ve cortado.
  ...
  Widget build(BuildContext context) {
    ...
    // Si esta campana está visible, ella anima y NotificacionesFx no duplica.
    // `TickerMode.valuesOf` crea la dependencia: sin ella el registro se queda
    // viejo al cambiar de pestaña porque no habría rebuild.
