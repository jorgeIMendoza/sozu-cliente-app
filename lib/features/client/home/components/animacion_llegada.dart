...
/// Duración de la coreografía completa. NO es un token de `context.s.motion`:
/// esa escala tope en 380 ms (transiciones de estado) y recortarla ahí dejaría
/// las fases de arriba sin tiempo de leerse. Cambiarla obliga a revisarlas.
const kDuracionAnimacion = Duration(milliseconds: 2300);

/// Frame de la animación en el instante `v` (0-1): el proyectil viajando de
/// `centro` a `destino`, en coordenadas del Stack contenedor (Overlay o
/// preview). Motor compartido entre la campana real y el demo del admin.
