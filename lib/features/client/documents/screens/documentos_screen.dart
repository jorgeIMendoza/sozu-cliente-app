...
/// Documentos del cliente: stats por estatus, filtros, agrupación colapsable por
/// propiedad o estado, hoja de detalle y secciones de facturas CFDI.
...
class _DetalleFacturaState extends State<_DetalleFactura> {
  ...
  /// Empaqueta el PDF + XML de la factura en un solo `.zip` y lo dispara como
  /// una descarga. Fuera de web (sin blob) o ante error, cae a [_descargarEnSecuencia].
