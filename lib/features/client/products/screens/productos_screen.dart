...
class _ProductosScreenState extends ConsumerState<ProductosScreen> {
  ...
  /// Vista modo portal (web >=1024): grid de productos por propiedad. Solo capa
  /// visual: mismo provider, buscador y navegación que la vista móvil.
  Widget _portalVista(
    int n,
  ...
  /// Detalle in-page de una propiedad: cabecera con botón volver, tabs por
  /// producto (o cabecera simple si solo hay uno) e historial del seleccionado.
