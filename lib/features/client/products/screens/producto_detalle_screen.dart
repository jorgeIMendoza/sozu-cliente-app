...
class _ProductoDetalleScreenState extends ConsumerState<ProductoDetalleScreen> {
  ...
  /// Vista modo portal (web >=1024): solo la cabecera de la ruta directa
  /// (/productos/:cuentaId); el historial lo pinta [ProductoPortalHistorial].
...
/// Historial de un producto en modo portal: filtros + tabla "Movimientos" a la
/// izquierda y card resumen a la derecha. Lo comparten la ruta directa y el
/// detalle in-page de ProductosScreen. No pinta el título: lo pone quien embebe.
