...
21 archivos suenan a muchos, pero son **10 conceptos**: cuatro de ellos son
...
| | |
|---|---|
| `open_document.dart` · `open_media.dart` | Abrir un PDF o una imagen con el visor que toque |
| `media_cache.dart` | Cache en disco a 7 dias. La clave es estable porque las URLs firmadas caducan y llegan distintas cada vez |
